// @Author zhangjiaozhu 2024/2/27 18:56:00
package user
...
// 可以修改为配置文件，以下内容在讯飞api控制台获取
var (
	hostUrl   = "wss://spark-api.xf-yun.com/v1.1/chat"
	appid     = "e66a86a2"
	apiSecret = "NjI3YzdiNmIyMmE1NTAzOWIzNDk0MDdm"
	apiKey    = "50fcbb104cf83482c990ffbb81fd082a"
)

func GptService(msg string) (string, error) {
